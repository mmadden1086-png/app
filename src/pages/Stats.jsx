...
import TrackRecord from '@/components/follow-through/TrackRecord';
    ...
    <div className="min-h-screen bg-background pb-24">
      <header className="sticky top-0 z-30 bg-background/95 backdrop-blur-md border-b border-border/50">
        <div className="max-w-lg mx-auto flex items-center px-4 py-3">
          ...
          <h1 className="text-lg font-extrabold tracking-tight">Track Record</h1>
        </div>
      </header>
      <div className="max-w-lg mx-auto pt-4">
        <TrackRecord tasks={tasks} />
      </div>
      <BottomNav />
    </div>
  );
